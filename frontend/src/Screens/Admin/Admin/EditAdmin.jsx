  ...
  return (
    <div className="my-6 mx-auto w-full">
      ...
      >
        <input
          type="text"
          className="px-6 py-3 w-full outline-none text-black" // Added text-black class
        ...
        >
          <div className="w-[40%]">
            ...
            <input
              ...
              className="w-full bg-blue-50 rounded border focus:border-dark-green focus:bg-secondary-light focus:ring-2 focus:ring-light-green text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out text-black" // Added text-black class
            />
          </div>
          <div className="w-[40%]">
          ...
          <div className="w-[40%]">
            ...
            <select
              id="gender"
              className="px-2 bg-blue-50 py-3 rounded-sm text-base w-full accent-blue-700 mt-1 text-black" // Added text-black class
              value={data.gender}
