        ...
        >
          <div className="w-[40%]">
            ...
            <input
              ...
              className="text-black w-full bg-blue-50 rounded border focus:border-dark-green focus:bg-secondary-light focus:ring-2 focus:ring-light-green text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
          <div className="w-[40%]">
          ...
          <div className="w-[40%]">
            ...
            <select
              disabled
              id="semester"
              className="px-2 bg-gray-50 py-3 rounded-sm text-black w-full accent-blue-700 mt-1"
              value={data.semester}
          ...
          <div className="w-[40%]">
            ...
            <select
              disabled
              id="branch"
              className="text-black px-2 bg-blue-50 py-3 rounded-sm  w-full accent-blue-700 mt-1"
              value={data.branch}
          ...
          <div className="w-[40%]">
            ...
            <select
              id="gender"
              className="text-black px-2 bg-blue-50 py-3 rounded-sm text-base w-full accent-blue-700 mt-1"
              value={data.gender}
          ...
          <div className="w-[40%]">
            ...
            <label
              htmlFor="file"
              className="px-2 bg-blue-50 py-3 rounded-sm text-black  w-full flex justify-center items-center cursor-pointer"
            >
              Upload
              <span className="ml-2">
                <FiUpload />
          ...
          <button
            type="submit"
            className="bg-teal-500 px-6 py-3 rounded-xl mb-6 text-white"
          >
            Update Student
          </button>
        </form>
