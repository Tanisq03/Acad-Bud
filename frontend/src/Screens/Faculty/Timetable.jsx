    ...
    <div className="w-full mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      ...
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          ...
          <select
            id="branch"
            className="px-2 bg-blue-50 py-3 rounded-sm text-black w-[80%] accent-blue-700 mt-4"
          ...
          >
            ...
            {branch &&
              branch.map((branch) => {
                return (
                  <option className="text-black" value={branch.name} key={branch.name}>
                    {branch.name}
                  </option>
                );
              })}
          ...
          {!addselected.link && (
            <label
              htmlFor="upload"
              className="px-2 bg-blue-50 py-3 rounded-sm text-black w-[80%] mt-4 flex justify-center items-center cursor-pointer"
            >
              Select Timetable
              <span className="ml-2">
                <FiUpload />
          ...
          {previewUrl && (
            <p
              className="px-2 border-2 border-cyan-500 py-2 rounded text-base w-[80%] mt-4 flex justify-center items-center cursor-pointer"
              onClick={() => {
                setFile("");
                setPreviewUrl("");
              }}
          ...
          />
          <button
            className="bg-teal-500 text-white mt-8 px-4 py-2 rounded-xl"
