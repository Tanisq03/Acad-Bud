        ...
        <div className="w-1/2 flex flex-col justify-center items-center">
          <div className="w-[80%] mt-2">
            ...
            <input
              type="text"
              id="title"
              className="bg-blue-50 py-2 px-4 w-full mt-1 text-black"
          ...
          <div className="w-[80%] mt-2">
            ...
            <select
              ...
              className="px-2 bg-blue-50 py-3 rounded-sm text-black accent-blue-700 mt-1 w-full"
            >
          ...
          {selected.link && (
            <p
              className="px-2 border-2 border-blue-500 py-2 rounded text-black w-[80%] mt-4 flex justify-center items-center cursor-pointer"
