    ...
    <div className="w-full mx-auto flex justify-center items-start flex-col my-10">
        ...
        <>
          <div className="mt-10 w-full flex justify-evenly items-center gap-x-6">
            <div className="w-full">
              <label htmlFor="branch" className="leading-7 text-gray-50 ">
                Select Branch
              </label>
              <select
                id="branch"
          ...
          <button
            className="bg-teal-500 px-4 py-2 mt-8 mx-auto rounded-xl border-2 border-teal-600 text-gray-50"
      ...
      {studentData && studentData.length !== 0 && (
        <>
          ...
          >
            {studentData.map((student) => {
              return (
                ...
                >
                  <p className="text-lg px-4 w-1/2 bg-50">
                    {student.enrollmentNo}
                  </p>
                  <input
                    type="number"
                    className="px-6 py-2 focus:ring-0 outline-none w-1/2 bg-inherit"
          ...
          <button
            className="bg-teal-500 px-6 py-3 mt-8 mx-auto rounded-xl text-white"
