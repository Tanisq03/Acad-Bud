        ...
        <>
          <div>
            <p className="text-2xl font-semibold">
              Namaste, {data[0].firstName} {data[0].middleName} {data[0].lastName}{" "}
              🙏
            </p>
            <div className="mt-3">
            ...
            {showPass && (
              ...
              >
                ...
                <input
                  ...
                  className="px-3 py-1 border-2 border-teal-500 outline-none rounded mt-4"
                />
                <button
                  className="mt-4 bg-teal-500 hover:border-b-2 hover:border-teal-500"
