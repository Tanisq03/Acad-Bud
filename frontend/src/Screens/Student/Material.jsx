      ...
      <div className="mt-8 w-full flex justify-center items-center flex-col">
        <div className="flex justify-center items-center w-[40%]">
          <select
            ...
            className="px-2  py-3 rounded-sm text-black accent-blue-700"
          >
            <option defaultValue value="select" className="text-black">
              -- Select Subject --
            </option>
            {subject &&
              subject.map((item) => {
                return (
                  <option value={item.name} key={item.name} className="text-black">
                    {item.name}
                  </option>
                );
              })}
